...
// All four are "coming soon" for now. Resume Vault (built, Phase 4) is
// a different feature from Resume Architect (the AI resume *builder*,
// not yet built) — and Job Hunter / Interview Coach / Career Roadmap
// have no real pages yet either. Flip an entry's status to "ready" (and
// give it an href) as each one actually ships.
const AGENTS: AgentCardDef[] = [
  {
    name: "Resume Architect",
    description: "AI-assisted resume building and ATS optimization.",
    icon: FileText,
    status: "coming-soon",
  },
  {
